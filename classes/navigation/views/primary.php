...
if ($showcoursesnode) {
    ...
    // My courses
    $this->add(get_string('mycourses'), new \moodle_url('/my/courses.php'),
        self::TYPE_ROOTNODE, null, 'mycourses');

    // All courses (unique key + forced into menu)
    $node = $this->add('All courses', new \moodle_url('/local/allcourses/index.php'),
        self::TYPE_ROOTNODE, null, 'allcourses'); // ✅ unique key
